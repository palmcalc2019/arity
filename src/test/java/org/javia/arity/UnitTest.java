...
//        new EvalCase("im(nan)", Double.NaN),
        new EvalCase("10%+20%+30%", 0.6),
            new EvalCase("27408.31-27408.35", -0.04),
            new EvalCase("2.2 * 3", 6.6),
            new EvalCase("2+10%", 2.1),
            new EvalCase("(2+30%)%", 0.023),
            new EvalCase("20% * 30%", 0.06),
            new EvalCase("789456123456789-789456123456788", 1),
            new EvalCase("1-0.25-6", -5.25)
